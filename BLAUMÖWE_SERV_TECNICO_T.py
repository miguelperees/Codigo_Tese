...
def start_blaumowe_serv_tecnico():
        ...
        ################                    RECOLHA DE CONTORNOS PRESENTES NA MÁSCARA                   ####################
            ...
            ########                RESTRIÇÃO PARA DETEÇÃO APENAS DO ALVO DO LASER ATRAVÉS DO SEU TAMANHO             ##########
                ...
                if 20 < radius < 27:
                    ...
                    #cv2.circle(frame, (int(x) + 382, int (y) + 250), int(radius), (0, 255, 0), 2)
            ...
            if k == 13:
                ...
                screenshot.save('C:/Users/installation/Desktop/Print (56x)/Ajuste_do_Display_e_do_Recetor.png')
